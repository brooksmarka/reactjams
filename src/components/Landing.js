...
const Landing = () => (
  <section className="landing">
    <div className="vh-100 dt w-100 tc cover">
      <div className="dtc v-mid">
        <div className="hero-title orange f1 pv3">Turn the music up!</div>
      </div>
    </div>
    <section className="selling-points cf ph2-ns">
      <div className="point fl w-100 vh-50-m vh-50-ns bg-turq w-third-ns pa2">
